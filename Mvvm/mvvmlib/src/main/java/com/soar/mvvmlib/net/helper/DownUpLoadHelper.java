package com.soar.mvvmlib.net.helper;

import android.text.TextUtils;

import com.soar.mvvmlib.net.HttpInfo;
import com.soar.mvvmlib.net.annotation.DownloadStatus;
...
import com.soar.mvvmlib.net.handler.OkMainHandler;
import com.soar.mvvmlib.net.progress.ProgressRequestBody;
import com.soar.mvvmlib.net.progress.ProgressResponseBody;
import com.soar.mvvmlib.net.util.EncryptUtil;
import com.soar.mvvmlib.net.util.MediaTypeUtil;
